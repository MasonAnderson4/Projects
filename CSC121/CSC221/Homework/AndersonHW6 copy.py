...
def calcAQI(pollutant, concentration):
    #make dictionary if you got time
    pollutants = {"PM2.5":[0,12,12.1,35.4,35.5,55.4,55.5,150.4,150.5,250.4,250.5,500.4],
...
##                       [0,4.4,4.5,9.4,9.5,12.4,12.5,15.4,15.5,30.4,30.5,50.4],[0,0.054,0.055,0.070,0.071,0.085,0.086,0.105,0.106,0.200]]
    ...
    for key in pollutants:
        if pollutant == pollutants[key]:
            final = calcFinal(pollutants[value],concentration)
            return final
